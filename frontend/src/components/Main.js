                        ...
                        <form id="form">
                            ...
                            <div className="test-configuration">
                                ...
                                <div className="form-group">
                                    <label htmlFor="rules-questions">Rules questions</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="signs-questions">Signs questions</label>
                                ...
                                <div className="form-group">
                                    ...
                                    <label htmlFor="sendEmail">Send my score by email</label>
                                </div>
                            </div>
